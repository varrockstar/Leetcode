...
Given a string of bits, return the number of steps to arrive at 1.
If the binary representation of the string is even, divide by 2.
If the binary representation of the  string is odd, add 1. 
*/
